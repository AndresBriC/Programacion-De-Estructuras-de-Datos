...
public:
    ...
    static std::vector<T> quicksort(std::vector<T> e, bool compara (T, T));
    static std::vector<T> quicksort(std::vector<T> e, int primero, int ultimo, bool compara (T, T));

    static std::vector<T> mergesort(std::vector<T> e, int l, int n, bool compara (T, T));
    static std::vector<T> merge(std::vector<T> e, int l, int m, int n, bool compara (T, T));
...
std::vector<T> Ordenamiento<T>::quicksort(std::vector<T> e, int primero, int ultimo, bool compara (T, T))
{
    ...
    if ( primero < ultimo) // Paso base
    {
        ...
        // Se intercambia el pivote con el elemento de la posicion derecha
