...
template <class V, class E>
Vertex<V, E> * Graph<V,E>::getVertex(int index){
    return & (*nodes[index]);
}

template <class V, class E>
bool Graph<V,E>::findVertex(V value){
    bool found = false;
    for (int i = 0; i < nodes.size(); i++){
        if (nodes[i]->getInfo() == value){
            found = true;
            break;
        }
    }
...
template <class V, class E>
Vertex<V, E> * Graph<V,E>::getVertex(V value){
    Vertex<V, E> * found;
    for (int i = 0; i < nodes.size(); i++){
        if (nodes[i]->getInfo() == value){
            found = nodes[i];
