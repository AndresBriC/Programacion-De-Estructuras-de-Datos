...
void ConexionesComputadora::llenarConexionesEntrantes(string ip){
    ...
    stack<Registro> vacio;
    conexionesEntrantes = vacio;
    ...
    while(getline(archivo, line)){
        ...
        //En las conexiones entrantes la direcciÛn ip aparece como ip destino
        if (ipDestino == ip){
...
void ConexionesComputadora::llenarConexionesSalientes(string ip){
    ...
    queue<Registro> vacio;
    conexionesSalientes = vacio;
    ...
    while(getline(archivo, line)){
        ...
        //En las conexiones saliente la direcciÛn ip aparece como ip fuente
        if (ipOrigen == ip){
            //Agrega los registros al final de la queue
